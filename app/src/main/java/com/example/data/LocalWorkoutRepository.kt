...
class LocalWorkoutRepository(context: Context) {
    ...
    private val prefs: SharedPreferences =
        context.getSharedPreferences("stride_local_data", Context.MODE_PRIVATE)
    ...
    private fun getDefaultMilestones(): List<Milestone> {
        return listOf(
            Milestone("m_1", "First Step", "Complete your very first activity in Stride", MilestoneCategory.COUNT, 1.0, "activity", isUnlocked = true, unlockedDateMs = System.currentTimeMillis() - 86400000L * 3, iconName = "footsteps"),
            ...
            Milestone("m_11", "10 Activity Veteran", "Log 10 workouts in Stride", MilestoneCategory.COUNT, 10.0, "activities", isUnlocked = false, iconName = "shield")
        )
    }
